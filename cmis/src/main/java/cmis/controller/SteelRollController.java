...
public class SteelRollController {
    ...
    @RequestMapping(value = "/api/bank/findAllSteelRoll", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
    @ResponseBody
    public List<SteelRoll> findAllSteelRoll() {
        return this.steelRollService.queryAllSteelRoll();
    }
    @RequestMapping(value = "/api/bank/deleteSteelRoll", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
    @ResponseBody
